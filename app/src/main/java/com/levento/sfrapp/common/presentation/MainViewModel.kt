...
import com.levento.sfrapp.common.utils.populate
import com.levento.sfrapp.common.utils.sortCategories
...
class MainViewModel @Inject constructor(
  ...
  //  private val imageLoadHelper = HtmlImageParser(application)
    ...
    private suspend fun getBenefits() {
        ...
        val benefitResponse = benefitsRepository.getAllBenefits()
